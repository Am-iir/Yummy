...
import restaurantapp.yummy.com.yummy.adapter.ViewPagerAdapter;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewPagerAdapter  viewPagerAdapter = new ViewPagerAdapter(getSupportFragmentManager(),mTablayout.getTabCount()); //passing onto view page adapter in adapter folder
